...
def _constant_ductility_iteration(
    ...
    results = pd.DataFrame(None, columns=['T', 'Sa', 'E', 'Fy', 'uy', 'R', 'maxDisp', 'maxVel', 'maxAccel', 'Ec', 'Ev', 'maxReaction', 'CD', 'CPD','resDisp', 'solving_converge', 'iter_converge', 'n_iter', 'miu', 'tol'])
