...
class Ui_Win(object):
    ...
    def retranslateUi(self, Win):
        ...
        self.label_10.setText(_translate("Win", "任务名："))
        self.label_2.setText(_translate("Win", "分析类型："))
        self.label_8.setText(_translate("Win", "求解器："))
        self.label_4.setText(_translate("Win", "地震动数量："))
        self.label_3.setText(_translate("Win", "SDOF数量："))
        self.label_9.setText(_translate("Win", "总计算数："))
        self.label_5.setText(_translate("Win", "多进程计算核心数："))
        self.groupBox.setTitle(_translate("Win", "计算进度"))
        self.label_6.setText(_translate("Win", "已计算地震动：0"))
        self.label_7.setText(_translate("Win", "已计算次数：0"))
        self.pushButton_4.setText(_translate("Win", "保存"))
